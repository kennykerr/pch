...
WINRT_EXPORT namespace winrt::Windows::Phone::UI::Input
{
    struct __declspec(empty_bases) BackPressedEventArgs : Windows::Phone::UI::Input::IBackPressedEventArgs
    {
        ...
        BackPressedEventArgs(BackPressedEventArgs const&) noexcept = default;
        BackPressedEventArgs(BackPressedEventArgs&&) noexcept = default;
        BackPressedEventArgs& operator=(BackPressedEventArgs const&) & noexcept = default;
        BackPressedEventArgs& operator=(BackPressedEventArgs&&) & noexcept = default;
    };
    struct __declspec(empty_bases) CameraEventArgs : Windows::Phone::UI::Input::ICameraEventArgs
    {
        ...
        CameraEventArgs(CameraEventArgs const&) noexcept = default;
        CameraEventArgs(CameraEventArgs&&) noexcept = default;
        CameraEventArgs& operator=(CameraEventArgs const&) & noexcept = default;
        CameraEventArgs& operator=(CameraEventArgs&&) & noexcept = default;
    };
