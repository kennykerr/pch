...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<Windows::Phone::Devices::Power::IBattery>{ 0x972ADBDD,0x6720,0x4702,{ 0xA4,0x76,0xB9,0xD3,0x8A,0x00,0x70,0xE3 } }; // 972ADBDD-6720-4702-A476-B9D38A0070E3
    template <> inline constexpr guid guid_v<Windows::Phone::Devices::Power::IBatteryStatics>{ 0xFAF5BC70,0x6369,0x11E1,{ 0xB8,0x6C,0x08,0x00,0x20,0x0C,0x9A,0x66 } }; // FAF5BC70-6369-11E1-B86C-0800200C9A66
