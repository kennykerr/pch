...
WINRT_EXPORT namespace winrt::Windows::UI::Core::AnimationMetrics
{
    struct __declspec(empty_bases) AnimationDescription : Windows::UI::Core::AnimationMetrics::IAnimationDescription
    {
        ...
        AnimationDescription(AnimationDescription const&) noexcept = default;
        AnimationDescription(AnimationDescription&&) noexcept = default;
        AnimationDescription& operator=(AnimationDescription const&) & noexcept = default;
        AnimationDescription& operator=(AnimationDescription&&) & noexcept = default;
    };
    struct __declspec(empty_bases) OpacityAnimation : Windows::UI::Core::AnimationMetrics::IOpacityAnimation
    {
        ...
        OpacityAnimation(OpacityAnimation const&) noexcept = default;
        OpacityAnimation(OpacityAnimation&&) noexcept = default;
        OpacityAnimation& operator=(OpacityAnimation const&) & noexcept = default;
        OpacityAnimation& operator=(OpacityAnimation&&) & noexcept = default;
    };
    struct __declspec(empty_bases) PropertyAnimation : Windows::UI::Core::AnimationMetrics::IPropertyAnimation
    {
        ...
        PropertyAnimation(PropertyAnimation const&) noexcept = default;
        PropertyAnimation(PropertyAnimation&&) noexcept = default;
        PropertyAnimation& operator=(PropertyAnimation const&) & noexcept = default;
        PropertyAnimation& operator=(PropertyAnimation&&) & noexcept = default;
    };
    struct __declspec(empty_bases) ScaleAnimation : Windows::UI::Core::AnimationMetrics::IScaleAnimation
    {
        ...
        ScaleAnimation(ScaleAnimation const&) noexcept = default;
        ScaleAnimation(ScaleAnimation&&) noexcept = default;
        ScaleAnimation& operator=(ScaleAnimation const&) & noexcept = default;
        ScaleAnimation& operator=(ScaleAnimation&&) & noexcept = default;
    };
    struct __declspec(empty_bases) TranslationAnimation : Windows::UI::Core::AnimationMetrics::IPropertyAnimation
    {
        ...
        TranslationAnimation(TranslationAnimation const&) noexcept = default;
        TranslationAnimation(TranslationAnimation&&) noexcept = default;
        TranslationAnimation& operator=(TranslationAnimation const&) & noexcept = default;
        TranslationAnimation& operator=(TranslationAnimation&&) & noexcept = default;
    };
}
#endif
