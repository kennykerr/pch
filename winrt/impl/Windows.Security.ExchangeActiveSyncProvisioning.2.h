...
WINRT_EXPORT namespace winrt::Windows::Security::ExchangeActiveSyncProvisioning
{
    ...
    struct __declspec(empty_bases) EasClientSecurityPolicy : Windows::Security::ExchangeActiveSyncProvisioning::IEasClientSecurityPolicy
    {
        ...
        EasClientSecurityPolicy(EasClientSecurityPolicy const&) noexcept = default;
        EasClientSecurityPolicy(EasClientSecurityPolicy&&) noexcept = default;
        EasClientSecurityPolicy& operator=(EasClientSecurityPolicy const&) & noexcept = default;
        EasClientSecurityPolicy& operator=(EasClientSecurityPolicy&&) & noexcept = default;
    };
        ...
        impl::require<EasComplianceResults, Windows::Security::ExchangeActiveSyncProvisioning::IEasComplianceResults2>
    {
        ...
        EasComplianceResults(EasComplianceResults const&) noexcept = default;
        EasComplianceResults(EasComplianceResults&&) noexcept = default;
        EasComplianceResults& operator=(EasComplianceResults const&) & noexcept = default;
        EasComplianceResults& operator=(EasComplianceResults&&) & noexcept = default;
    };
}
#endif
