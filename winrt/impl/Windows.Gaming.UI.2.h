...
WINRT_EXPORT namespace winrt::Windows::Gaming::UI
{
    ...
    struct __declspec(empty_bases) GameChatMessageReceivedEventArgs : Windows::Gaming::UI::IGameChatMessageReceivedEventArgs
    {
        ...
        GameChatMessageReceivedEventArgs(GameChatMessageReceivedEventArgs const&) noexcept = default;
        GameChatMessageReceivedEventArgs(GameChatMessageReceivedEventArgs&&) noexcept = default;
        GameChatMessageReceivedEventArgs& operator=(GameChatMessageReceivedEventArgs const&) & noexcept = default;
        GameChatMessageReceivedEventArgs& operator=(GameChatMessageReceivedEventArgs&&) & noexcept = default;
    };
    ...
    struct __declspec(empty_bases) GameChatOverlayMessageSource : Windows::Gaming::UI::IGameChatOverlayMessageSource
    {
        ...
        GameChatOverlayMessageSource(GameChatOverlayMessageSource const&) noexcept = default;
        GameChatOverlayMessageSource(GameChatOverlayMessageSource&&) noexcept = default;
        GameChatOverlayMessageSource& operator=(GameChatOverlayMessageSource const&) & noexcept = default;
        GameChatOverlayMessageSource& operator=(GameChatOverlayMessageSource&&) & noexcept = default;
    };
    struct __declspec(empty_bases) GameUIProviderActivatedEventArgs : Windows::Gaming::UI::IGameUIProviderActivatedEventArgs
    {
        ...
        GameUIProviderActivatedEventArgs(GameUIProviderActivatedEventArgs const&) noexcept = default;
        GameUIProviderActivatedEventArgs(GameUIProviderActivatedEventArgs&&) noexcept = default;
        GameUIProviderActivatedEventArgs& operator=(GameUIProviderActivatedEventArgs const&) & noexcept = default;
        GameUIProviderActivatedEventArgs& operator=(GameUIProviderActivatedEventArgs&&) & noexcept = default;
    };
}
#endif
