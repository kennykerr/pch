...
WINRT_EXPORT namespace winrt::Windows::Media::AppRecording
{
    struct __declspec(empty_bases) AppRecordingManager : Windows::Media::AppRecording::IAppRecordingManager
    {
        ...
        AppRecordingManager(AppRecordingManager const&) noexcept = default;
        AppRecordingManager(AppRecordingManager&&) noexcept = default;
        AppRecordingManager& operator=(AppRecordingManager const&) & noexcept = default;
        AppRecordingManager& operator=(AppRecordingManager&&) & noexcept = default;
    ...
    struct __declspec(empty_bases) AppRecordingResult : Windows::Media::AppRecording::IAppRecordingResult
    {
        ...
        AppRecordingResult(AppRecordingResult const&) noexcept = default;
        AppRecordingResult(AppRecordingResult&&) noexcept = default;
        AppRecordingResult& operator=(AppRecordingResult const&) & noexcept = default;
        AppRecordingResult& operator=(AppRecordingResult&&) & noexcept = default;
    };
    struct __declspec(empty_bases) AppRecordingSaveScreenshotResult : Windows::Media::AppRecording::IAppRecordingSaveScreenshotResult
    {
        ...
        AppRecordingSaveScreenshotResult(AppRecordingSaveScreenshotResult const&) noexcept = default;
        AppRecordingSaveScreenshotResult(AppRecordingSaveScreenshotResult&&) noexcept = default;
        AppRecordingSaveScreenshotResult& operator=(AppRecordingSaveScreenshotResult const&) & noexcept = default;
        AppRecordingSaveScreenshotResult& operator=(AppRecordingSaveScreenshotResult&&) & noexcept = default;
    };
    struct __declspec(empty_bases) AppRecordingSavedScreenshotInfo : Windows::Media::AppRecording::IAppRecordingSavedScreenshotInfo
    {
        ...
        AppRecordingSavedScreenshotInfo(AppRecordingSavedScreenshotInfo const&) noexcept = default;
        AppRecordingSavedScreenshotInfo(AppRecordingSavedScreenshotInfo&&) noexcept = default;
        AppRecordingSavedScreenshotInfo& operator=(AppRecordingSavedScreenshotInfo const&) & noexcept = default;
        AppRecordingSavedScreenshotInfo& operator=(AppRecordingSavedScreenshotInfo&&) & noexcept = default;
    };
    struct __declspec(empty_bases) AppRecordingStatus : Windows::Media::AppRecording::IAppRecordingStatus
    {
        ...
        AppRecordingStatus(AppRecordingStatus const&) noexcept = default;
        AppRecordingStatus(AppRecordingStatus&&) noexcept = default;
        AppRecordingStatus& operator=(AppRecordingStatus const&) & noexcept = default;
        AppRecordingStatus& operator=(AppRecordingStatus&&) & noexcept = default;
    };
    struct __declspec(empty_bases) AppRecordingStatusDetails : Windows::Media::AppRecording::IAppRecordingStatusDetails
    {
        ...
        AppRecordingStatusDetails(AppRecordingStatusDetails const&) noexcept = default;
        AppRecordingStatusDetails(AppRecordingStatusDetails&&) noexcept = default;
        AppRecordingStatusDetails& operator=(AppRecordingStatusDetails const&) & noexcept = default;
        AppRecordingStatusDetails& operator=(AppRecordingStatusDetails&&) & noexcept = default;
    };
}
#endif
