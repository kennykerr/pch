...
WINRT_EXPORT namespace winrt::Windows::Globalization
{
    ...
    struct __declspec(empty_bases) JapanesePhoneme : Windows::Globalization::IJapanesePhoneme
    {
        ...
        JapanesePhoneme(JapanesePhoneme const&) noexcept = default;
        JapanesePhoneme(JapanesePhoneme&&) noexcept = default;
        JapanesePhoneme& operator=(JapanesePhoneme const&) & noexcept = default;
        JapanesePhoneme& operator=(JapanesePhoneme&&) & noexcept = default;
    };
