...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel::Preview::Notes
{
    struct __declspec(empty_bases) NotePlacementChangedPreviewEventArgs : Windows::ApplicationModel::Preview::Notes::INotePlacementChangedPreviewEventArgs
    {
        ...
        NotePlacementChangedPreviewEventArgs(NotePlacementChangedPreviewEventArgs const&) noexcept = default;
        NotePlacementChangedPreviewEventArgs(NotePlacementChangedPreviewEventArgs&&) noexcept = default;
        NotePlacementChangedPreviewEventArgs& operator=(NotePlacementChangedPreviewEventArgs const&) & noexcept = default;
        NotePlacementChangedPreviewEventArgs& operator=(NotePlacementChangedPreviewEventArgs&&) & noexcept = default;
    };
    struct __declspec(empty_bases) NoteVisibilityChangedPreviewEventArgs : Windows::ApplicationModel::Preview::Notes::INoteVisibilityChangedPreviewEventArgs
    {
        ...
        NoteVisibilityChangedPreviewEventArgs(NoteVisibilityChangedPreviewEventArgs const&) noexcept = default;
        NoteVisibilityChangedPreviewEventArgs(NoteVisibilityChangedPreviewEventArgs&&) noexcept = default;
        NoteVisibilityChangedPreviewEventArgs& operator=(NoteVisibilityChangedPreviewEventArgs const&) & noexcept = default;
        NoteVisibilityChangedPreviewEventArgs& operator=(NoteVisibilityChangedPreviewEventArgs&&) & noexcept = default;
    };
        ...
        impl::require<NotesWindowManagerPreview, Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreview2>
    {
        ...
        NotesWindowManagerPreview(NotesWindowManagerPreview const&) noexcept = default;
        NotesWindowManagerPreview(NotesWindowManagerPreview&&) noexcept = default;
        NotesWindowManagerPreview& operator=(NotesWindowManagerPreview const&) & noexcept = default;
        NotesWindowManagerPreview& operator=(NotesWindowManagerPreview&&) & noexcept = default;
    ...
    struct __declspec(empty_bases) NotesWindowManagerPreviewShowNoteOptions : Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreviewShowNoteOptions
    {
        ...
        NotesWindowManagerPreviewShowNoteOptions(NotesWindowManagerPreviewShowNoteOptions const&) noexcept = default;
        NotesWindowManagerPreviewShowNoteOptions(NotesWindowManagerPreviewShowNoteOptions&&) noexcept = default;
        NotesWindowManagerPreviewShowNoteOptions& operator=(NotesWindowManagerPreviewShowNoteOptions const&) & noexcept = default;
        NotesWindowManagerPreviewShowNoteOptions& operator=(NotesWindowManagerPreviewShowNoteOptions&&) & noexcept = default;
    };
}
#endif
