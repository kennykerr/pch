...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<Windows::Media::Effects::ISlowMotionEffectDefinition>{ 0x35053CD0,0x176C,0x4763,{ 0x82,0xC4,0x1B,0x02,0xDB,0xE3,0x17,0x37 } }; // 35053CD0-176C-4763-82C4-1B02DBE31737
