...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<Windows::Media::Capture::IScreenCapture>{ 0x89179EF7,0xCD12,0x4E0E,{ 0xA6,0xD4,0x5B,0x3D,0xE9,0x8B,0x2E,0x9B } }; // 89179EF7-CD12-4E0E-A6D4-5B3DE98B2E9B
    template <> inline constexpr guid guid_v<Windows::Media::Capture::IScreenCaptureStatics>{ 0xC898C3B0,0xC8A5,0x11E2,{ 0x8B,0x8B,0x08,0x00,0x20,0x0C,0x9A,0x66 } }; // C898C3B0-C8A5-11E2-8B8B-0800200C9A66
    template <> inline constexpr guid guid_v<Windows::Media::Capture::ISourceSuspensionChangedEventArgs>{ 0x2ECE7B5E,0xD49B,0x4394,{ 0xBC,0x32,0xF9,0x7D,0x6C,0xED,0xEC,0x1C } }; // 2ECE7B5E-D49B-4394-BC32-F97D6CEDEC1C
